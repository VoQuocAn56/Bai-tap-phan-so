...
namespace BatTapPhanSo
{
    class PhanSo
    {
        ...
        {
            //rút gọn phân số 1 và phân số 2 trước khi thực hiện phép cộng.
            ...
            else
            {
                ...
                int boiSoChung = BoiSoChungNhoNhat(phanSo1.MauSo, phanSo2.MauSo);
        ...
        public string Tru(PhanSo phanSo1, PhanSo phanSo2)
        {
            ...
            {
                //nếu mẫu số khác nhau. Tìm bcnn giữa 2 mẫu số.
                int bscnn = BoiSoChungNhoNhat(phanSo1.MauSo, phanSo2.MauSo);

                //chia 2 mẫu số của 2 phần số cho bscnn.
                //vd 1/2, 1/3 bscnn là 6 -> ThuaSoChung1 = 6/2 = 3,ThuaSoChung2 = 6/3 = 2
                int ThuaSoChung1 = bscnn / phanSo1.MauSo;
                int ThuaSoChung2 = bscnn / phanSo2.MauSo;

                //Tính hiệu tử số, mẫu số là bội số chung nhỏ nhất.
                //vd 1/2, 1/3 -> hiệu tử số = 1 * 3 + 1 * 2 = 1 -> (1/2 - 1/3) = 1/6
                int HieuTuSo = (phanSo1.TuSo * ThuaSoChung1) - (phanSo2.TuSo * ThuaSoChung2);

                //kết về kết quả của phép tính.
